...
pub fn pretty_diff(before: &str, after: &str) -> String {
    ...
    // Myers-style LCS diff via a simple DP table
...
#[cfg(test)]
mod pretty_diff_tests {
    use super::pretty_diff;

    #[test]
    fn test_pretty_diff_added_line() {
        let before = "line1\nline2";
        let after = "line1\nline2\nline3";
        let diff = pretty_diff(before, after);
        assert!(diff.contains("+line3"));
    }

    #[test]
    fn test_pretty_diff_removed_line() {
        let before = "line1\nline2\nline3";
        let after = "line1\nline3";
        let diff = pretty_diff(before, after);
    ...
    #[test]
    fn test_pretty_diff_unchanged() {
        let text = "hello\nworld";
        let diff = pretty_diff(text, text);
